  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://leadingcentres.com/wp-content/uploads/2017/10/glasgow-mini-slider1.jpg"
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://tse4.mm.bing.net/th/id/OIP.0S0VyHAMHx3jXUZyEvzl9gHaEK?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
          ...
          <div className="highlight-card">
            <img
              src="https://www.luxurylifestylemag.co.uk/wp-content/uploads/2025/07/royal-mile-medium.jpg"
          ...
          <div className="highlight-card">
            <img
              src="https://wallpapercat.com/w/full/f/c/7/682971-1920x1080-desktop-1080p-loch-ness-scottish-highlands-background-image.jpg"
          ...
          <div className="highlight-card">
            <img
              src="https://wallpapercat.com/w/full/b/a/6/1506718-1920x1080-desktop-1080p-loch-lomond-wallpaper-image.jpg"
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/914328.jpg"
              alt=""
            />
...
fashion, or the food, Edinburgh offers an abundance of experiences waiting to be explored. 
Overnight Stay in Edinburgh       
          ...
          <div className="day-card">
            <img
              src="https://cdn.platinumlist.net/upload/event-media-item/28729_hop_on_hop_off_edinburgh_24_hours-original1742904923.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
...
Overnight Stay in Edinburgh 
          ...
          <div className="day-card">
            <img
              src="https://media.tacdn.com/media/attractions-splice-spp-674x446/0f/45/b3/e0.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
...
Our Edinburgh tours depart from Castle Terrace, Edinburgh EH1 2EW, outside the NCP Car Park.  <br/> 
...
Overnight Stay in Edinburgh
          ...
          <div className="day-card">
            <img
              src="https://tse4.mm.bing.net/th/id/OIP.LyZS1fPQfLYrveBiRwYWHAHaE8?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
...
Train Details | XXHRS-XXXHRS | Edinburgh to Glasgow  <br/> 
...
Overnight Stay in Glasgow 
          ...
          <div className="day-card">
            <img
              src="https://cdn-imgix.headout.com/media/images/dc8bed4db38fe93d454934a190f54a86-24690-glasgow-city-sightseeing-1-2-day-hop-on-hop-off-tour-of-glasgow-011.jpg?auto=format&w=705.6&h=360&q=90&fit=crop&crop=faces"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
              ...
              <p>
       Breakfast at Hotel. <br/>  
Glasgow 01 Day Hop on Hop off City bus  <br/> 
...
Overnight Stay in Glasgow
          ...
          <div className="day-card">
            <img
              src="https://cdn.travelersuniverse.com/media/glenfinnan-viaduct-and-glencoe-day-tour-from-glasgow-d740-445133P1-6.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
...
www.apextiondmc.com  
LONDON | PARIS | NEW DELHI|MUMBAI<br/>  
Description: Depart Glasgow in the morning and travel north to the Highlands, stopping in Tyndrum 
...
Overnight Stay in Glasgow.
          ...
          <div className="day-card">
            <img
              src="https://cdn.wallpapersafari.com/66/42/wS0h4V.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
