  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://wallpapercave.com/wp/wp3382659.jpg"
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA1YBfiX.img?w=1920&h=1080&m=4&q=93"
              alt="Mount Titlis"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://cdn.pixabay.com/photo/2014/10/13/19/36/eiger-487217_960_720.jpg"
              alt="Grindelwald"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://tse3.mm.bing.net/th/id/OIP.x5IO4LcrlPN_kQ2p__tNaQHaEo?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt="Jungfraujoch"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://media.myswitzerland.com/image/fetch/c_lfill,g_auto,w_3200,h_1800/f_auto,q_80,fl_keep_iptc/https://www.myswitzerland.com/-/media/st/gadmin/images/cities/summer/cities/st0035293_36236.jpg"
              alt="Zurich"
            />
            <p>Zurich Old Town</p>
          </div>
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://adm.dookinternational.com/dook/images/poi/4s8DmQ1cxl1619440201.jpg"
              alt=""
            />
          ...
          <div className="day-card">
            <img
              src="https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA1YDjJs.img?w=1920&h=1080&m=4&q=93"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://tse1.mm.bing.net/th/id/OIP.WhZasIFPJIM_QTep-_1KxAHaE8?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://squarelilypad.com/wp-content/uploads/2020/06/jungfraujoch-grindelwald-16.jpeg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
          ...
          <div className="day-card">
            <img
              src="https://www.civitatis.com/f/suiza/zurich/galeria/casas-grindewald-suiza.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://cdn.getyourguide.com/img/tour/d4697b6c979fd6d9dc90aac1645858ee893450af33cc64210e6fc0413e69bc7c.jpg/98.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
