...
const faqs = [
  {
    ...
    answer:
      "May to September is ideal, with long daylight hours, mild weather and green landscapes across London and Edinburgh. Summer (June–August) is peak season, great for outdoor sightseeing and Highland excursions, while spring and early autumn offer fewer crowds and comfortable temperatures for city walks.",
  },
  {
    question: "What is included in the 9-day Grand Britain Experience package?",
    answer:
      "The package includes 7 nights accommodation (4 nights London, 3 nights Edinburgh), daily breakfast, comfortable coach transfers between cities, guided city tours in London and Edinburgh, and sightseeing at iconic landmarks along the way. International flights, visa fees and personal expenses are not included.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Highlights include the Tower Bridge and London Eye in London, the fairy-tale grandeur of Windsor Castle, the ancient mystery of Stonehenge and the Georgian charm of Bath, Edinburgh Castle and the Royal Mile, and a scenic day trip to the Scottish Highlands and Loch Ness.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely! This itinerary can be fully tailored to your preferences, travel dates, and budget. Whether you'd like to add an Isle of Skye excursion, extra nights in London, or upgrade your hotels, our team will curate the perfect personalised experience for you.",
  },
];
  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://i.pinimg.com/736x/ef/d8/bd/efd8bd9d7fb82dc0ef75e9868cf725d8.jpg"
          alt="Grand Britain Experience Tour"
        />
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://tse2.mm.bing.net/th/id/OIP.jOp9xgfc-haFn9xu8rNOdAHaEo?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
          ...
          <div className="highlight-card">
            <img
              src="https://tse4.mm.bing.net/th/id/OIP.9q538bHtByPFo5LKKGtlNQHaE8?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt="Windsor Castle"
            />
            <p>Windsor Castle</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://media.tacdn.com/media/attractions-splice-spp-674x446/07/1c/6d/f0.jpg"
              alt="Stonehenge"
            />
            <p>Stonehenge & Bath</p>
          </div>
      ...
      <div className="why-section">
        ...
        <div className="why-grid">
          ...
          <div>🗿 Ancient Stonehenge & Bath</div>
      ...
      <div className="cta-section">
        ...
        <p>
          From the royal grandeur of London to the storybook charm of Edinburgh — a journey through England and Scotland's finest
        </p>
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://tse3.mm.bing.net/th/id/OIP.lTVjbEP8b2e7mN1u6fnppAHaEK?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt=""
            />
...
Overnight Stay in London 
          ...
          <div className="day-card">
            <img
              src="https://cdn.getyourguide.com/img/tour/a78ad5ee7afb6c51c8410ed1ef24efb59a3cfab7b0e9fbaa4349e0a9c356cc51.jpg/146.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
...
A relaxing and scenic journey through the heart of the city <br />
 Overnight Stay in London 
          ...
          <div className="day-card">
            <img
              src="https://assets.discount-london.com/images/product/madame-tussauds-london-eye-tower-bridge/london-eye4-4-555x296.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
...
Overnight Stay in London 
          ...
          <div className="day-card">
            <img
              src="https://cdn.getyourguide.com/img/tour/6485b2c962556.jpeg/146.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
              ...
              <p>
         Breakfast at the hotel.<br /> 
Today, Cotswolds and Oxford Guided Day Trip from London on SIC Basis 
...
stop at Burford and Bourton-On-The-Water, the two most loved villages of the Cotswolds. 
...
Overnight Stay in London  
          ...
          <div className="day-card">
            <img
              src="https://wallpapercat.com/w/full/8/a/4/1424061-2560x1708-desktop-hd-edinburgh-skyline-background-image.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
              ...
              <p>
         Breakfast at the hotel.<br /> 
After breakfast, transfer from your London hotel to London Train Station by private vehicle. <br />
...
Overnight Stay in Edinburgh. 
          ...
          <div className="day-card">
            <img
              src="https://www.adventuresaroundscotland.com/uploads/2/4/2/9/24290443/edinburgh-citysightseeing-tour-bus_orig.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
              ...
              <p>
          Breakfast at the hotel.<br /> 
Today, explore Edinburgh with your Hop on Hop off City Tour. 
...
Overnight Stay in Edinburgh 
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/914324.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
...
Depart with wonderful memories of your UK trip.
          ...
          {/* <div className="day-card">
            ...
            <div className="day-content">
              ...
              <p style={{ color: "blue" }}>Edinburgh → India</p>
              <p>
                Arrive in India with beautiful memories of your Grand Britain Experience.<br/>
                Your memorable journey through England and Scotland comes to an end!
        ...
        <div style={{ textAlign: "center", marginTop: "36px" }}>
          <button
            ...
            onClick={() => setActiveModal("9 Days Grand Britain Experience Tour")}
          >
            Send Query
          </button>
        </div>
...
export default EnglandScotlandLanding;