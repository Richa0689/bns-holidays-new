  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://res.klook.com/images/fl_lossy.progressive,q_65/c_fill,w_1200,h_630/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/mq3onhabn8tbgmedint1/Discover%20Zurich:%20Guided%20Walking%20Tour%20of%20the%20City's%20Best%20Sights.jpg"
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperaccess.com/full/156797.jpg"
              alt="Vienna Austria"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperaccess.com/full/5643847.jpg"
              alt="Munich Germany"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://rare-gallery.com/uploads/posts/4504467-landscape-castle-neuschwanstein-castle-germany.jpg"
          ...
          <div className="highlight-card">
            <img
              src="https://tse3.mm.bing.net/th/id/OIP.4V-BZHZPgb-jNaS7ReZKEAHaE8?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/1664325.jpg"
              alt=""
            />
          ...
          <div className="day-card">
            <img
              src="https://hotels.cdn.express/hotels_photo/vienna/attr_vienna/SchonbrunnPalaceParkHoponHopoffPass/304576375.webp"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://vacations.aircanada.com/.imaging/focalarea/tabletlandscape/800x/dam/jcr:520e2cab-5afe-46d9-a303-3cc6ec4c4eac/Munich-Prague-Vienna-202603-MUCMPV-01_Munich-Marienplatz.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://res.klook.com/image/upload/c_fill,w_1265,h_712/q_80/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/m6tthxxlbunbs0zf9ypi.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/8466031.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://tourbeez.s3.amazonaws.com/uploads/all/lindt-home-of-chocolate-museum.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/1103385.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
