  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://tse1.mm.bing.net/th/id/OIP.hQ9yT9Lbx4GlHNIRgegiVAHaDD?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://christmasmarketsineurope.com/wp-content/uploads/Zurich-Switzerland-Happy-to-Wander-0928.jpg"
              alt="Zurich"
            />
            <p>Old Town, Zurich</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://c8.alamy.com/comp/GK9JGX/innsbruck-golden-roof-innsbruck-golden-roof-05-GK9JGX.jpg"
              alt="Innsbruck"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperbat.com/img/30673-salzburg-wallpaper-man-made-hq-salzburg-picture-4k.jpg"
              alt="Salzburg"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://images.pexels.com/videos/28891520/pexels-photo-28891520.jpeg?auto=compress&cs=tinysrgb&h=627&fit=crop&w=1200"
              alt="Alps"
            />
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/6418165.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://tse3.mm.bing.net/th/id/OIP.WVGKq-CCluhsFAZYiM9N0gHaE7?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://cdn.getyourguide.com/img/tour/5c935b2b623e3.jpeg/146.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
          ...
          <div className="day-card">
            <img
              src="https://www.shadesofsummr.com/wp-content/uploads/2023/09/innsbruck-jpg.webp"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://d2mgzmtdeipcjp.cloudfront.net/files/good/2025/02/14/17394993117654.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/8622153.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
