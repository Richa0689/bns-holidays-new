    ...
    <div className="usa-landing">
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://media.timeout.com/images/106276609/750/562/image.jpg"
              alt=""
            />
            <p>Prague Old Town</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://media1.thrillophilia.com/filestore/vgatnf0y74oxhh8qynnmldtyk6cs_shutterstock_222064795.jpg"
              alt=""
            />
            <p>Charles Bridge</p>
          </div>
      ...
      <div className="why-section">
        ...
        <div className="why-grid">
          ...
          <div>🚄 Comfortable Europe Transfers</div>
          <div>📸 Instagram-Worthy Architecture</div>
          <div>🍷 European Food & Nightlife</div>
        </div>
      </div>
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://media.tacdn.com/media/attractions-splice-spp-674x446/06/f1/5c/53.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 1</h3>
              <p style={{color:"blue"}}>Budapest City Highlights Sightseeing Cruise – Entrance Ticket & Tour (Included)<br/>Welcome to Hungary</p>
...
Overnight Stay in Budapest</p>
          ...
          <div className="day-card">
            <img
              src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/32/ce/0b/b0/caption.jpg?w=800&h=800&s=1"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
...
Overnight Stay in Budapest</p>
          ...
          <div className="day-card">
            <img
              src="https://blogofsunshine.com/wp-content/uploads/2025/06/st-stephens-cathedral-vienna-exterior.png"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
...
Overnight Stay in Vienna</p>
          ...
          <div className="day-card">
            <img
              src="https://t4.ftcdn.net/jpg/02/78/47/03/360_F_278470364_oLtBQcOFPtyy07N4qsdSnrL2C48Ze5iJ.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
...
Overnight Stay in Vienna</p>
          ...
          <div className="day-card">
            <img
              src="https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/07/3a/91/71.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
...
Overnight Stay in Vienna</p>
          ...
          <div className="day-card">
            <img
              src="https://d3dqioy2sca31t.cloudfront.net/Projects/cms/production/000/033/186/slideshow/aa3cc8bc14fc3f93c823f6aa5743874e/slide-czech-republic-prague-old-town-hall.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
...
Overnight Stay in Prague</p>
          ...
          <div className="day-card">
            <img
              src="https://cdn.britannica.com/23/177923-050-1ECAE329/Tyn-Church-Staromestske-Square-Prague.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 8</h3>
...
Overnight Stay in Prague</p>
          ...
          <div className="day-card">
            <img
              src="https://pub-94d1cc15a07543a1a84d2eef096b8d24.r2.dev/posts/03-letiste-praha-1772951328447-8h184k-lg.webp"
              alt=""
            />
            <div className="day-content">
              <h3>Day 9</h3>
...
export default EuropeLuxuryLanding;