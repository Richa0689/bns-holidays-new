...
const faqs = [
  {
    ...
    answer:
      "This Central European and Alpine route is wonderful year-round. Spring (April–May) is one of the most popular times — Vienna's gardens bloom, Munich's English Garden comes alive, and the Swiss Alps offer crisp clear views. Summer (June–August) brings long sunny days and vibrant outdoor culture across all three cities. Autumn (September–October) is perfect for golden Alpine scenery and fewer crowds. Winter (December) is magical — Vienna's Christkindlmarkt, Munich's festive old town, and Zurich's glittering Bahnhofstrasse create an unforgettable European winter experience.",
  },
  {
    question: "What is included in the 8-day tour package?",
    answer:
      "The package includes accommodation for 7 nights, daily breakfast, airport and station transfers, a 1-Day Hop-on Hop-off Bus Pass in Vienna (SIC basis), a Schönbrunn Palace entrance ticket (included), a Bratislava & Countryside Guided Half Day Tour (SIC basis, included), a 1-Day Hop-on Hop-off Bus Pass in Munich (SIC basis), a Swiss Travel Pass (3 Days Continuous – Second Class), and a visit to the Lindt Home of Chocolate in Zurich. Intercity train travel between Vienna, Munich, and Zurich is also included. International flights and personal expenses are not included.",
  },
  {
    question: "Do I need a visa to travel to Austria, Germany, and Switzerland?",
    answer:
      "Indian passport holders require a Schengen visa to visit Austria and Germany. Switzerland, while not an EU member, is part of the Schengen Area — so a single Schengen visa covers your entire 8-day journey across all three countries. We recommend applying at least 4–6 weeks in advance. Our team can guide you through the complete documentation and visa application process.",
  },
  {
    question: "Is this tour suitable for first-time Europe travellers?",
    answer:
      "Absolutely! This itinerary is thoughtfully crafted for first-time European travellers. It combines imperial Vienna, vibrant Munich, and cosmopolitan Zurich — with a relaxed pace, included guided experiences, and private transfers at every step. The Hop-on Hop-off buses make city exploration effortless, and the Swiss Travel Pass handles all transport within Switzerland.",
  },
  {
    question: "What is the Bratislava Half Day Tour included in the itinerary?",
    answer:
      "The Bratislava & Countryside Guided Half Day Tour (SIC basis) takes you from Vienna into western Slovakia for a cultural journey blending capital city highlights, historic castles, and authentic local experiences — all within easy reach of Vienna. It's a great way to experience an extra European capital without spending hours in transit, making your Vienna days even more enriching.",
  },
  {
    question: "Can I customise the Vienna–Munich–Zurich itinerary?",
    answer:
      "Yes! Every itinerary is fully customisable based on your interests, travel dates, and budget. Whether you'd like to add a Hallstatt day trip from Vienna, a Neuschwanstein Castle excursion from Munich, a Jungfraujoch or Mount Titlis trip from Zurich, or extend your stay in any city, our team will craft the perfect personalised Alpine European journey for you.",
  },
];
  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://media.cnn.com/api/v1/images/stellar/prod/190508160346-most-beautiful-places-in-austria-hallstatt.jpg?q=w_1600,h_900,x_0,y_0,c_fill"
          alt="Vienna Munich Zurich Tour"
        />

        <div className="hero-content">
          <h1>Best of Vienna / Munich / Zurich</h1>
          <p>Luxury Europe Journey. Scenic Alps. Historic Cities.</p>
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://images.winalist.com/blog/wp-content/uploads/2025/06/26123743/adobestock-118763263.jpeg"
              alt=""
            />
      ...
      <div className="why-section">
        ...
        <div className="why-grid">
          ...
          <div>🚆 Comfortable Europe Travel</div>
      ...
      <div className="cta-section">
        ...
        <p>Book your Vienna, Munich & Zurich tour today</p>
        <br />
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            ...
            <div className="day-content">
              ...
              <p>Welcome to Vienna – The Imperial Capital of Austria!
...
Habsburg Royal Family. Walk through its lavish rooms and beautiful palace gardens.
...
Overnight Stay in Vienna</p>
          ...
          <div className="day-card">
            <img
              src="https://cdn.getyourguide.com/image/format=auto,fit=crop,gravity=auto,quality=60,width=375,height=375,dpr=2/tour_img/92ece9e6774f811e65cd3a86bd3ae6cdfb3ee76b4bdcd7e58d3a330ac3b07527.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
              <p style={{color:"blue"}}>Bratislava & Countryside Guided Half Day Tour on sic basis</p>
              <p>The best of Bratislava and western Slovakia in a single, unforgettable day. This tour is designed for
...
Overnight Stay in Munich</p>
          ...
          <div className="day-card">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/0/0b/Image-Schloss_Nymphenburg_Munich_CC_edit3.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
...
Overnight Stay in Munich</p>
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaEPTlk2KxJCXPnAZQZIY8aUW-ySpzw6pWsQ&s"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
...
Overnight Stay in Zurich</p>
          ...
          <div className="day-card">
            <img
              src="https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/0b/d5/95/e3.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
