      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://img.freepik.com/free-photo/geneva-geneve-lake-water-jet-d-eau-switzerland_79295-9233.jpg?size=626&ext=jpg"
              alt="Geneva"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://wallpapercrafter.com/desktop/281992-lavaux-vineyard.jpg"
              alt="Lausanne"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://tse4.mm.bing.net/th/id/OIP.LxE-C5xSRq2KbMA_ma6iHQHaFN?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt="Chillon Castle"
            />
            <p>Chillon Castle</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperaccess.com/full/9587223.jpg"
              alt="Montreux"
            />
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://img.peapix.com/515654f063154114a9c566cbb58760fc_UHD.jpg?attachment&modal"
              alt=""
            />
          ...
          <div className="day-card">
            <img
              src="https://tse4.mm.bing.net/th/id/OIP.bT26_AZoipbVnDl7tmcPVAHaEK?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpapercave.com/wp/wp7054888.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://usercontent.one/wp/www.jungfrautours.ch/wp-content/uploads/2020/09/tilis_flyer_in_the_sky.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
          ...
          <div className="day-card">
            <img
              src="https://tse4.mm.bing.net/th/id/OIP.9ddnv0kiWAWED-R99G-wpwHaEo?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpaperbat.com/img/1944743-geneva-switzerland-marinas-coast-hdr-hd-wallpaper.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
