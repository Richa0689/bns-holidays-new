  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://tse1.mm.bing.net/th/id/OIP.nVx8Nc_UIjOakzhuYX0R2QHaDq?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://tse2.mm.bing.net/th/id/OIP.adYGjfEwLEmp8jU8cgT_LwHaFj?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperaccess.com/full/7946479.jpg"
              alt="Lake Geneva"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperaccess.com/full/1455117.jpg"
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://tse3.mm.bing.net/th/id/OIP.Z8tOgdNF-pwmG-QO7OwBoAAAAA?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpapercave.com/wp/wp3777176.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://www.travelonatimebudget.co.uk/wp-content/uploads/2023/07/Zurich-river.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://cdn.generationvoyage.fr/2025/03/La-Lindt-Home-of-Chocolate-a-Zurich-en-Suisse.jpeg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/1103105.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 8</h3>
