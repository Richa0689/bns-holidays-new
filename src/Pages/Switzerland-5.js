  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://images.resosys.com/deals/ca-switzerland-zurich-bern-geneva-basel-road-trip/itn_vpejk9-zurich-switzerland-old-town-skyline-over-the-limm-2024-03-08-17-08-31-utc.jpg"
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://switzerland-tour.com/storage/media/Zurich/Zurich-s-Old-Town.jpg"
              alt="Zurich"
            />
            <p>Old Town, Zurich</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://thirdeyetraveller.com/wp-content/uploads/Kapellbrucke-chapel-bridge-and-water-tower-in-lucerne-6-of-13-1536x1152.jpg"
              alt="Lucerne"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://www.balmers.com/wp-content/uploads/2025/02/best-waterfall-interlaken-lauterbrunnen-1024x726.jpg"
              alt="Interlaken"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://tse4.mm.bing.net/th/id/OIP.RcGZv-nroD8UPs9Q4YOweAHaE8?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt="Geneva"
            />
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/1103077.jpg"
              alt=""
            />
          ...
          <div className="day-card">
            <img
              src="https://wallpaperbat.com/img/859172-zurich-wallpaper-top-free-zurich-background.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://thumbs.dreamstime.com/b/zurich-switzerland-beautiful-autumn-sunset-cityscape-image-345929432.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpaperaccess.com/full/2073094.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpaperbat.com/img/1944658-photo-switzerland-geneva-lake-geneva-ferris-wheel-motorboat-cities.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
