    ...
    <div className="usa-landing">
      ...
      <div className="why-section">
        ...
        <div className="why-grid">
          <div>🏛️ Explore Historic Rome</div>
          <div>🎨 Discover Renaissance Florence</div>
          <div>📸 Visit Iconic Pisa</div>
      ...
      <div className="cta-section">
        ...
        <h2>Plan Your Italy Journey</h2>

        <p>
          Experience the beauty of Italy in 7 unforgettable days
        </p>
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            ...
            <div className="day-content">
              <h3>Day 1</h3>
              <p style={{color:"blue"}}>India – Florence <br/>Arrival in Florence: A Magical Start to Your Italian Adventure</p>
...
top and enjoy panoramic views of the surrounding Piazza dei Miracoli.
...
comfortable and scenic connection through the heart of Tuscany and Lazio.
