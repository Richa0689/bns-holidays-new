  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://cdn-imgix.headout.com/media/images/6597a1f06161c843b1753a12606d767a-23212-zurich-zurich-city-sightseeing-tour-with-lake-cruise-09.jpg?auto=format&w=1058.3999999999999&h=540&q=90&crop=faces&fit=crop"
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperaccess.com/full/5644330.jpg"
              alt="Munich"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperaccess.com/full/8466007.jpg"
              alt="Zurich"
            />
            <p>Old Town, Zurich</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperaccess.com/full/844198.jpg"
              alt="Alps"
            />
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://res.klook.com/images/fl_lossy.progressive,q_65/c_fill,w_1295,h_863/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/h1vqedmmy439nli1jfvk/ViennaHop-OnHop-OffBus.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://res.klook.com/images/w_1200,h_630,c_fill,q_65/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/fakffq6tl26fxveoy0ji/Bratislava%20%26%20Devin%20Castle%20Half-Day%20Guided%20Tour.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://wallpaperbat.com/img/200961893-three-days-in-munich.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
          ...
          <div className="day-card">
            <img
              src="https://cdn-imgix.headout.com/media/images/1e93534a494d20e8b194c5a026973f54-25616--citysightseeing-munich--24-48-hr-hop-on-hop-off---round-trip-munich-01.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://www.lindt-home-of-chocolate.com/wp-content/uploads/2020/04/lindt-chocolate-shop-720x470-1.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
          ...
          <div className="day-card">
            <img
              src="https://cdn.wallpapersafari.com/50/75/3FnJQI.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 8</h3>
