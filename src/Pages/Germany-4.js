  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://wallpapers.com/images/hd/europe-lake-bled-in-slovenia-nwma7tqaqfsq158j.jpg"
          alt="Europe Tour"
        />
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperbat.com/img/200961817-visit-munich-city-centre-2025-munich-city-centre-munich-travel-guide.jpg"
              alt="Munich"
            />
            <p>Munich Streets</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://wallpaperbat.com/img/858984-wallpaper-lights-lake-the-evening-switzerland-zurich-image-for-desktop-section-gorod.jpg"
              alt="Zurich"
            />
            <p>Zurich Lake</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://images.alphacoders.com/127/thumb-1920-1271701.jpg"
              alt="Alps"
            />
            <p>Swiss Alps</p>
          </div>
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://cdn.getyourguide.com/image/format=auto,fit=crop,gravity=auto,quality=60,dpr=1/tour_img/b95542988f074605.jpeg"
              alt=""
            />
...
Overnight Stay in Vienna
          ...
          <div className="day-card">
            <img
              src="https://cdn-imgix.headout.com/media/images/b82fe6b4de4c27e43f91a129afbec9c3-Schonbrunn%20Palace%20aerial.jpg?auto=format&w=1222.3999999999999&h=687.6&q=90&fit=crop&ar=16:9&crop=faces"
              alt=""
            />
...
Overnight Stay in Vienna
          ...
          <div className="day-card">
            <img
              src="https://wallpaperbat.com/img/200961919-days-in-munich-munich-itinerary-vienna-blog.jpg"
              alt=""
            />
...
Overnight Stay in Munich
          ...
          <div className="day-card">
            <img
            src="https://m.jtgtravel.com/img/munich-city-hop-on-hop-off-tour-d487-28501-3.jpg"
              alt=""
            />
...
Overnight Stay in Munich
          ...
          <div className="day-card">
            <img
            src="https://untuckworld.com/wp-content/uploads/2023/08/Munich-to-Zurich-train.jpg"
              alt=""
            />
...
Overnight Stay in Zurich
          ...
          <div className="day-card">
            <img
            src="https://tse1.mm.bing.net/th/id/OIP.wn75tOuZi6c2E4ZberTiWQHaHa?r=0&cb=thfc1falcon4&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt=""
            />
