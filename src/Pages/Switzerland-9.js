    ...
    <div className="usa-landing">
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://cdn.audleytravel.com/3663/2616/79/15986030-interlaken.jpg"
              alt="Interlaken"
            />
            <p>Interlaken</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://th.bing.com/th/id/OIP.vESaFjx7J70gzbAuFAQKgQHaFj?r=0&o=7rm=3&rs=1&pid=ImgDetMain&o=7&rm=3"
          ...
          <div className="highlight-card">
            <img
              src="https://tse3.mm.bing.net/th/id/OIP.1bp4jhDqg3d912vfHAEwJwHaE8?r=0&rs=1&pid=ImgDetMain&o=7&rm=3"
              alt="Montreux"
            />
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://i.ytimg.com/vi/ERhFjxAfHAs/maxresdefault.jpg"
              alt=""
            />
          ...
          <div className="day-card">
            <img
              src="https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/12/73/8c/8a.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://media-cdn.tripadvisor.com/media/attractions-splice-spp-720x480/06/67/ac/96.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://www.winetraveler.com/wp-content/uploads/2023/03/prettiest-swiss-mountain-villages-to-visit.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
          ...
          <div className="day-card">
            <img
              src="https://usercontent.one/wp/www.jungfrautours.ch/wp-content/uploads/2020/09/jungfraubahn_moench_jungfrau.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://www.switzerlandical.com/wp-content/uploads/2023/02/Zermatt-Winter-Night.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
          ...
          <div className="day-card">
            <img
              src="https://cdn-imgix.headout.com/media/images/cf37f3c0af7ebd63b513c182f08776ae-Matterhorn%20Glacier%20Paradise%20april.jpg?auto=format&q=90&crop=faces&fit=crop"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
          ...
          <div className="day-card">
            <img
              src="https://www.ecosign.com/images/Projects/switzerland/zermatt/_projectHeroOptimizer/16129/zermatt-valley-winter-hero.webp"
              alt=""
            />
            <div className="day-content">
              <h3>Day 8</h3>
          ...
          <div className="day-card">
            <img
              src="https://media.myswitzerland.com/image/fetch/c_lfill,g_auto,w_3200,h_1800/f_auto,q_80,fl_keep_iptc/https://www.myswitzerland.com/-/media/st/gadmin/images/destinations/winter/bridge/st0037307_les_diablerets_110955.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 9</h3>
          ...
          <div className="day-card">
            <img
              src="https://highways.today/wp-content/uploads/2022/11/euston4.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 10</h3>
