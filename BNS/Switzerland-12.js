  ...
  return (
    <div className="usa-landing">
      ...
      <div className="hero-section">
        <img
          src="https://loremflickr.com/1600/900/zurich,switzerland,lake"
      ...
      <div className="highlights">
        ...
        <div className="highlight-grid">
          ...
          <div className="highlight-card">
            <img
              src="https://loremflickr.com/600/450/zurich,cityscape"
              alt="Zurich"
            />
            <p>Zurich Old Town</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://loremflickr.com/600/450/bern,switzerland"
              alt="Bern"
            />
            <p>Bern Old City</p>
          </div>
          ...
          <div className="highlight-card">
            <img
              src="https://loremflickr.com/600/450/geneva,lake"
              alt="Geneva"
            />
          ...
          <div className="highlight-card">
            <img
              src="https://loremflickr.com/600/450/montblanc,alps"
              alt="Mont Blanc"
            />
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://loremflickr.com/600/400/zurich,airport"
              alt=""
            />
          ...
          <div className="day-card">
            <img
              src="https://loremflickr.com/600/400/zurich,oldtown"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://loremflickr.com/600/400/luzern,mountain"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://loremflickr.com/600/400/bern,clocktower"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
          ...
          <div className="day-card">
            <img
              src="https://loremflickr.com/600/400/gruyeres,castle"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://loremflickr.com/600/400/geneva,jetdeau"
              alt=""
            />
            <div className="day-content">
              <h3>Day 6</h3>
          ...
          <div className="day-card">
            <img
              src="https://loremflickr.com/600/400/geneva,airport"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
