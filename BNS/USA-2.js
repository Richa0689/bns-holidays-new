    ...
    <div className="usa-landing">
      ...
      <div className="itinerary-section">
        ...
        <div className="itinerary-list">
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSr6Js-WpYPyipdFDLooeNetZ8HjaGo7Xj2BYPMpe9yc6nOjToCnOhuRqg&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 2</h3>
          ...
          <div className="day-card">
            <img
              src="https://res.klook.com/images/w_1200,h_630,c_fill,q_65/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/jdptb1yn4rvgjbmfgavc/WashingtonDCandPhiladelphiaDayTourfromNewYork-Klook.jpghttps://res.klook.com/images/w_1200,h_630,c_fill,q_65/w_80,x_15,y_15,g_south_west,l_Klook_water_br_trans_yhcmh3/activities/jdptb1yn4rvgjbmfgavc/WashingtonDCandPhiladelphiaDayTourfromNewYork-Klook.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 3</h3>
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSboIDqPJbEsFcU9IbPW4PKeiH9EVqTtko_fTQJe--l-EGjVh4q8VuqRJo&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 4</h3>
              <p style={{ color: "blue" }}>Washington, D.C. → Harrisburgr</p>
              <p>
               Morning<br/>
          ...
          <div className="day-card">
            <img
              src="https://www.jetbluevacations.com/cdn-cgi/image/f=auto,width=804,height=1080/https://www.jetbluevacations.com/media/BUF_niagara_falls_8753116a67/BUF_niagara_falls_8753116a67.jpg"
              alt=""
            />
            <div className="day-content">
              <h3>Day 5</h3>
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlRH7_DgKMIEo-y3s-IohJHUNzCJnOC0BtXsOa_aWxVtlnlfKMi_5zXW8&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 7</h3>
              <p style={{ color: "blue" }}>FLYOUT TO LAS VEGAS FROM BUFFALO</p>
              <p>
                 After breakfast, our representative will pick you up from the hotel for private airport transfer based on your individual flights (please note that check-out time is 11:00 a.m.).
                 Packed breakfast is not available for passengers taking early flights.
                 Your departure flight will be out of BUF (private airport transfer included in your cost)<br/> 
                 Upon arrival in Las Vegas, proceed to the baggage claim area and call the driver using the contact number provided on your voucher. The driver will direct you to the designated meeting point for your complimentary airport pick-up.
                 Check in to your hotel (check-in 4:00 p.m.) and settle in.<br/>
                 Evening Experience:<br/>
                 Meet the Tour Escort at 6.00 PM
                 Enjoy a delicious dinner at a local Indian restaurant.<br/>
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-0U2S9hHndLLRdAi2puOhvqmqfd6g73aGqHm7bSeJKg&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 8</h3>
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIifKKbfOeT66qeQxpdUR_W2BsR5FaCAgcWnsy8ItbuQ&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 9</h3>
              ...
              <p>
              Morning<br/>
             Enjoy breakfast en route to Los Angeles as you journey through the desert landscapes of Nevada and California.
             Stop at Ontario Mills Mall, Southern California’s largest outlet shopping destination, featuring designer labels and popular brand-name stores.<br/>
              Afternoon<br/>
               ...
               Evening<br/>
               Conclude the day with a delicious dinner before checking in to your hotel.<br/>
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUoo2cAGLhDjQ-Kp-__etU52ucURXPP_yXFxhbudvFGg&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 10</h3>
              ...
              Spend the morning at Universal Studios Hollywood, where thrilling theme park rides meet wher I mention Page the whole page need to be replacesdreal film production sets. Enjoy behind-the-scenes experiences, live shows, and immersive attractions that bring movie magic to life.<br/>
               Afternoon<br/>
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlYa2IAcPmzwIaGeAUdAbcyj8-2Et9xboUPo1W4_EN2g&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 11</h3>
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgfawrMWr5VOlaaHMvUBZ5rDmEel7qW7mm6dhhEQ59zsxSjig2viburFml&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 12</h3>
              ...
              <p>
               ...
               Begin with a delicious breakfast at the hotel  before setting out on a full day of sightseeing in San Francisco.<br/>
               Bay Cruise: Sail along the waterfront with panoramic views of the Golden Gate Bridge, Alcatraz Island, and the glittering city skyline.
          ...
          <div className="day-card">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcfwnygxlNR1tMKbZVPM9D2PZZ09xZKsxkPxYE87w-Zg&s=10"
              alt=""
            />
            <div className="day-content">
              <h3>Day 13</h3>
              <p style={{ color: "blue" }}><br/>Departure from San Francisco</p>
              <p>
                Morning
